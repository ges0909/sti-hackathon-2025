...
class CovidMapData:
    ...
    Attributes:
        ...
        cases (int): FÃ¤lle Example: 4711.
        cases_per_100k (float): FÃ¤lle/100.000 EW Example: 4711.123.
        cases7per100k (float): FÃ¤lle der letzten 7 Tage/100.000 EW Example: 47.11123.
        deaths (int): TodesfÃ¤lle
