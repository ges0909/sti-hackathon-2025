...
class ARSCovidRules:
    ...
    Attributes:
        ...
        general_info (Union[Unset, str]):  Example: <p><span>Grundsätzlich gilt: </span></p><p><span>Abstand + Hygiene +
            Maske im Alltag + Corona-Warn-App + Lüften</span></p><p><span data-stringify-type=paragraph-break/><span>Keine
            Testpflicht + keine Ausgangsbeschränkungen + keine Kontaktbeschränkungen für Geimpfte und Genesene</span></p>.
