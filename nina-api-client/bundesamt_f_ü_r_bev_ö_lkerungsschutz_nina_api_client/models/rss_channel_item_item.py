...
class RssChannelItemItem:
    ...
    Attributes:
        ...
        description (Union[Unset, str]):  Example: Dies ist die Entwarnung zur Warnung "Rauchgase - Eschweiler-Röthgen"
            vom 04.04.2023 18:56:51 gesendet durch LS Aachen, StÃ¤dteregion (DEU, NW, Aachen). (Hier kommen Beschreibung und
            Handlungsanweisungen)
            --- Diese Warnmeldung stammt aus dem Modularen Warnsystem (MoWaS) des Bundesamtes für Bevölkerungsschutz und
            Katastrophenhilfe. Sie darf nur inhaltlich unverÃ¤ndert und nicht zu gewerblichen Zwecken verwendet werden. Um
            die AuthentizitÃ¤t der Warnmeldung zu überprüfen gehen Sie auf https://warnung.bund.de. Eine EinschrÃ¤nkung oder
